...
public class SearchMealAdapter extends RecyclerView.Adapter<SearchMealAdapter.SearchFoodViewHolder> implements Filterable {

    private ArrayList<String> foodArrayList, foodArrayListFull;
    private OnItemClickListener onItemClickListener;

    public SearchMealAdapter(ArrayList<String> foodArrayList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SearchMealAdapter.SearchFoodViewHolder holder, int position) {
        final String currentItem = foodArrayList.get(position);
        holder.foodNameTextView.setText(currentItem);
        holder.foodTypeTextView.setText("Total de Hidratos: " +String.valueOf(MainActivity.diaDataDatabase.mealDao().getSomaHidratos(currentItem))+"g");
    }
